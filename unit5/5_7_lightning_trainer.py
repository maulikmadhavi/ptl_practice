...
if __name__ == "__main__":
    ...
    # save checkpoints
    trainer.save_checkpoint("logs/lightning_model.ckpt")
    # Load model checkpoint
    lightning_model = LightningModel.load_from_checkpoint("logs/lightning_model.ckpt", model=model)
    ...
    with torch.no_grad():
        ...
        print(f"Test Accuracy from loaded model: {accuracy * 100:.2f}%")
